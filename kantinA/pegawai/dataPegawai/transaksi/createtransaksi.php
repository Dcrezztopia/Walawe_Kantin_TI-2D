                                            ...
                                            <div class=" row card-body">
                                                <div class="col-md-6">
                                                    <div style="display: grid; grid-template-columns:1fr 1fr;">
                                                        <div class="form-group" id="skuFormGroup">
                                                            ...
                                                            <input type="text" name="sku" id="skuInput"
                                                                class="form-control" placeholder="RT001-001-STRW"
                                                                required="">
                                                            <span>Sisa Barang: XX</span>
                                                        </div>

                                                        <div class="d-flex"
                                                            style="align-items: center; overflow: auto;">
                                                    ...
                                                    <div style="display: grid; grid-template-columns:1fr 1fr;">
                                                        <div class="form-group" id="jumlahFormGroup">
                                                            ...
                                                            <input type="number" name="harga" id="jumlahInput"
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="form-group w-100" id="angkaNominal"
                                                            style="padding-left: 0;">
                                                            <span id="total"
                                                                style="color: red; font-size: 40px">1000</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card-action w-100">
                                                    ...
                                                    <a href="">
                                                        <button type="submit" name="bayar" class="btn btn-success"><i
                                                                class="fa fa-usd" aria-hidden="true"></i> Bayar</button>
                                                    </a>
                                                </div>
                                            </div>
                                        </form>
                                            ...
                                            <div class="table-responsive">
                                                <table id="add-row" class="display table table-striped table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <td></td>
                                                        <td>
                                                            <a href="" data-toggle="modal" title="Hapus"
