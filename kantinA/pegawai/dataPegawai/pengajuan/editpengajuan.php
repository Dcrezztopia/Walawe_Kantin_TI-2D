                        ...
                        <div class="card">
                            ...
                            <form method="POST" enctype="multipart/form-data" action="">
                                <div class="modal-body">
                                    ...
                                    <div class="form-group col-md-4 ml-3">
                                        <label>SKU</label>
                                        <input value="<?php echo $pengajuan['sku'] ?>" type="text" name="sku"
                                            class="form-control" placeholder="SKU ..." required="">
                                    </div>
                                    <div class="form-group col-md-4 ml-3">
                                        <label>Nama Supplier</label>
                                        <input value="<?php echo $pengajuan['namasupplier'] ?>" type="text"
                                            name="namasupplier" class="form-control" placeholder="Nama Supplier ..."
                                            required="">
                                    </div>
                                    <div class="form-group col-md-4 ml-3">
                                        <label>Harga</label>
                                        <input value="<?php echo $pengajuan['harga'] ?>" type="number" name="harga"
