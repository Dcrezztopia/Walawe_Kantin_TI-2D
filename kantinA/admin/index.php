...
<body>
    <div class="wrapper">
            ...
            <div class="sidebar-wrapper scrollbar-inner">
                <div class="sidebar-content">
                    <ul class="nav">
                        ...
                        <li class="nav-item">
                            <a href="?view=datapengajuanbarang">
                                <i class="fas fa-briefcase"></i>
        ...
        <?php
                    ...
                    // Data Pengajuan Barang - Master
                    elseif($_GET['view']=='datapengajuan')
                        include 'master/pengajuan/datapengajuan.php';

                    // Data Barang
                    elseif($_GET['view']=='databarang')
                        include 'dataAdmin/databarang.php';

                    // Data dari pegawai (blm dibenerin nama file nya)
                    elseif($_GET['view']=='detailpinjambarang')
                        include '../pegawai/peminjaman/barang/detailpinjambarang.php';
                    elseif($_GET['view']=='datapengajuanbarang')
                        include 'dataAdmin/datapengajuanbarang.php';
                    elseif($_GET['view']=='detailpengajuan')
                        include '../pegawai/peminjaman/pengajuan/detailpinjampengajuan.php';
		?>
