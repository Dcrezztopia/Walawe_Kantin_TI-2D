                        ...
                        <div class="row card-body">                           
                            ...
                            <div class="col-sm-4 mb-4">
                                <div class="form-group" id="namaFormGroup">
									...
									<input type="text" id="nama" class="form-control" value="Muhammad Ariel Saputra" readonly>
								</div>
                                <div class="form-group" id="usernameFormGroup">
									<label class="fw-bold">Username</label>
									<input type="text" id="usrname" class="form-control" value="ariel" readonly>
								</div>
                                <div class="form-group" id="nipFormGroup">
									<label class="fw-bold">NIP</label>
									<input type="number" id="nip" class="form-control" value="18203812" readonly>
								</div>
                                <div class="form-group" id="passwordFormGroup">
									<label class="fw-bold">Password</label>
									<input type="password" id="password" class="form-control" value="123" readonly>
								</div>
