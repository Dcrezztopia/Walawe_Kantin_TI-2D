			...
			<form method="POST" enctype="multipart/form-data" action="">
				<div class="modal-body">
					<div class="form-group">
						...
						<input type="text" name="namaBarang" class="form-control" placeholder="Barang" required="">
					</div>
					<div class="form-group">
			...
			<div class="modal-content">
				...
				<form method="POST" enctype="multipart/form-data" action="">
					<div class="modal-body">
						...
						<div class="form-group">
							<label>Nama Barang</label>
							<input value="<?php echo $d['namaBarang'] ?>" type="text" name="namaBarang" class="form-control" placeholder="Barang" required="">
						</div>
						<div class="form-group">
							<label>Jenis Barang</label>
							<select name="jenisBarang" class="form-control" required="">
						...
						<div class="form-group">
							<label>SKU</label>
							<input value="<?php echo $d['SKU'] ?>" type="number" name="SKU" class="form-control" placeholder="SKU" required="">
						</div>
						<div class="form-group">
							<label>Nama Supplier</label>
							<input value="<?php echo $d['namaSupplier'] ?>" type="number" name="namaSupplier" class="form-control" placeholder="Nama Supplier" required="">
						</div>
						<div class="form-group">
							<label>Gambar</label>
