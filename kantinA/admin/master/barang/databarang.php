                                ...
                                <table id="add-row" class="display table table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#modalDetailBarang<?php echo $barang['id'] ?>"
                                                    data-toggle="modal" title="Detail" class="btn btn-xs btn-success"><i
                                                        class="fa fa-eye"></i></a>
                                                <a href="#modalEditBarang<?php echo $barang['id'] ?>"
                                                    data-toggle="modal" title="Edit" class="btn btn-xs btn-primary"><i
                                                        class="fa fa-edit"></i></a>
                                                <a href="#modalHapusBarang<?php echo $barang['id'] ?>"
        ...
        <div class="modal-content">
            ...
            <form method="POST" enctype="multipart/form-data" action="">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Nama Barang</label>
                        <input value="<?php echo $d['nama_barang'] ?>" type="text" name="nama_barang"
        ...
        <div class="modal-content">
            ...
            <form method="POST" enctype="multipart/form-data" action="">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Nama Barang</label>
                        <input readonly value="<?php echo $k['nama_barang'] ?>" type="text" name="nama_barang"
                            class="form-control" placeholder="Nama Barang ..." required="">
                    </div>
                    <div class="form-group">
                        <label>Stok</label>
                    ...
                    <div class="form-group">
                        ...
                        <textarea readonly class="form-control" rows="5" name="deskripsi" style="white-space: pre-line;"
