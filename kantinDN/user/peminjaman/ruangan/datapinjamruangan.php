										...
										<table id="add-row" class="display table table-striped table-hover" >
											...
											<tbody>
												...
												<tr>
													...
													<td>
													<a href="index.php?page=anggota/edit&id=<?= $row['user_id'] ?>" class="btn btn-warning btn-xs">Edit</a>
                                        			<a href="fungsi/hapus.php?anggota=hapus&id=<?= $row['user_id'] ?>" onclick="javascript:return confirm('Hapus Data Anggota ?');" class="btn btn-danger btn-xs">Hapus</a>
													</td>
												</tr>
											<?php } ?>
											<?php } ?>
